...
class AnalisaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($count >= 7){
                    ...
                    foreach ($pp['gejala'] as $z => $v) {
                        ...
                        if($is_next_exist){
                            ...
                            if($hasil_akhir == 0){
                                ...
                                $hitung  = $hitung + $ngejala->CF * (1-$hitung); // Hitung sama dengan oldcf iterasi sebelum nya
                            }
            ...
            return redirect()->back()->with('error', 'Mohon Maaf Penyakit Tidak Terdeteksi. Silahkan Hubungi Dokter Terdekat.');
        }
    }

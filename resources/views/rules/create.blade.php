        ...
        <div class="card">
        	<div class="card">
                ...
                <div class="body">
                    ...
                    <form method="POST" action="{{ URL::to('/do-add-rules') }}">
                    	@csrf
                            ...
                            <div class="form-line">
                                <select class="form-control" name="penyakit_id" required="">
                                    ...
                                    @foreach($penyakit AS $vp)
                                        <option value="{{ $vp->id }}">{{ $vp->nama_penyakit }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-line">
                                <select class="form-control" name="gejala_id" required="">
                                    ...
                                    @foreach($gejala AS $vg)
                                        <option value="{{ $vg->id }}">{{ $vg->nama_gejala }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
